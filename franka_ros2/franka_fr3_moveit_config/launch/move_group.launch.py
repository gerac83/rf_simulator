...
def generate_launch_description():
    ...
    robot_ip = 'dont-care' #LaunchConfiguration(robot_ip_parameter_name)
    load_gripper = 'true' #LaunchConfiguration(load_gripper_parameter_name)
    use_fake_hardware = 'true' #LaunchConfiguration(use_fake_hardware_parameter_name)
    mock_sensor_commands = 'true' #LaunchConfiguration(mock_sensor_commands_parameter_name)
