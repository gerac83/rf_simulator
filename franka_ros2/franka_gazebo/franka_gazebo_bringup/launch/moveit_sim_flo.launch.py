...
def generate_launch_description():
    ...
    return LaunchDescription(
        [robot_arg,
         ...
         db_arg,
         rviz_node, # Not needed
        #  joint_state_broadcaster_spawner,
        #  joint_trajectory_controller_spawner,
        #  robot_state_publisher, # Not needed
         run_move_group_node,
        #  ros2_control_node, # Not needed
        #  joint_state_publisher, # Not needed
        #  franka_robot_state_broadcaster, # Not needed
         gripper_launch_file
         ] + load_controllers
    )
